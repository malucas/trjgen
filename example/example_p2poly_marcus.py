...
knots = np.array([0, 1.0, 2.5]) # One second each piece
...
tj.pp2file(Dt, x_coeff, y_coeff, z_coeff, w_coeff, "./wall_land.csv")
print(w_coeff)

tjh.plotTraj(Xtj, Ytj, Ztj, Wtj, Zbtj, tv, [0,1,2],0.05)
